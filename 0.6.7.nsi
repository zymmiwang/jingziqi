...
!define PRODUCT_PUBLISHER "zymmiwang"
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\wangyiyun.exe"
...
OutFile "jingziqi-0.6.7-setup.exe"
...
Section "MainSection" SEC01
  ...
  File "bin\Release\wangyiyun.exe"
  ...
  File "bin\Release\url.txt"
  File "bin\Release\update.pdb"
  File "bin\Release\update.exe.config"
  ...
  File "bin\Release\supping-qidong.exe.config"
  File "bin\Release\supping-qidong.exe"
  File "bin\Release\snapshot_blob.bin"
  File "bin\Release\search.txt"
  File "bin\Release\pssuspend.exe"
  File "bin\Release\pepflashplayer.dll"
  File "bin\Release\Ninject.xml"
  File "bin\Release\Ninject.dll"
  File "bin\Release\netstandard.dll"
  File "bin\Release\MySql.Data.dll"
  File "bin\Release\Microsoft.Win32.Primitives.dll"
  File "bin\Release\libcef.dll"
  File "bin\Release\kuwo.pdb.bak"
  File "bin\Release\kuwo.exe.config.bak"
  File "bin\Release\kuwo.exe.bak"
  File "bin\Release\jingziqi.exe.config"
  File "bin\Release\jingziqi.exe"
  File "bin\Release\jingziqi.cer"
  File "bin\Release\ItachiUIBunifu.dll"
  File "bin\Release\Interop.WMPLib.dll"
  File "bin\Release\info.txt"
  File "bin\Release\icudtl.dat"
  File "bin\Release\freevip.pdb"
  File "bin\Release\freevip.exe.config"
  File "bin\Release\freevip.exe"
  File "bin\Release\freemusic.exe.config"
  File "bin\Release\freemusic.exe"
  ...
  File "bin\Release\AxInterop.WMPLib.dll"
  SetOutPath "$INSTDIR\music"
  File "bin\Release\music\cengjingdeni.wav"
  SetOutPath "$INSTDIR\swiftshader"
  File "bin\Release\swiftshader\libGLESv2.dll"
  File "bin\Release\swiftshader\libEGL.dll"
  SetOutPath "$INSTDIR\byn"
  File "bin\Release\byn\jingziqi.resources.dll"
  SetOutPath "$INSTDIR\tupian"
  File "bin\Debug\2333\*.*"
SectionEnd
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\wangyiyun.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\wangyiyun.exe"
...
Section Uninstall
  ...
  Delete "$INSTDIR\byn\jingziqi.resources.dll"
  Delete "$INSTDIR\swiftshader\libEGL.dll"
  Delete "$INSTDIR\swiftshader\libGLESv2.dll"
  Delete "$INSTDIR\music\cengjingdeni.wav"
  ...
  Delete "$INSTDIR\freemusic.exe"
  Delete "$INSTDIR\freemusic.exe.config"
  ...
  Delete "$INSTDIR\ItachiUIBunifu.dll"
  Delete "$INSTDIR\jingziqi.cer"
  Delete "$INSTDIR\jingziqi.exe"
  Delete "$INSTDIR\jingziqi.exe.config"
  Delete "$INSTDIR\kuwo.exe.bak"
  Delete "$INSTDIR\kuwo.exe.config.bak"
  Delete "$INSTDIR\kuwo.pdb.bak"
  ...
  Delete "$INSTDIR\search.txt"
  Delete "$INSTDIR\snapshot_blob.bin"
  Delete "$INSTDIR\supping-qidong.exe"
  Delete "$INSTDIR\supping-qidong.exe.config"
  ...
  Delete "$INSTDIR\update.pdb"
  Delete "$INSTDIR\url.txt"
  Delete "$INSTDIR\v8_context_snapshot.bin"
  Delete "$INSTDIR\wangyiyun.exe"
