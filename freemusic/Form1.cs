...
namespace freemusic
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("版本信息：freemusic v1.2.0 \n----------\nQ：为什么下载正在播放的文件报错？\nA：一般来说是有同名文件，自己修改一下吧。\nQ：为什么有些歌曲无法播放？\nA：由于众所周知的原因，平台会对VIP文件特殊加密（不然赚什么钱呢），但奇怪的是部分VIP歌曲能够下载，并且部分免费歌曲无法下载。emmm...总比没有强，，，\nQ：（承接上问）：那你这个有什么用呢？！\nA：聊胜于无，起码不像酷我和酷狗半道偷袭，本来一切正常1.1.0写完后几个月就更改了，VIP全部作废（拜托，我可是费了一番时间的啊啊啊）。\n----------\n更新日志：1.2.0 重构美化（源码丢失，迫不得已）；增加播放插件；修复结果条数少于固定条数报错bug；去除已失效酷我和酷狗平台，增加网易云平台···\n    1.1.0 增加下载功能。\n    1.0.0支持酷我、酷狗平台全部歌曲播放。\n----------\n1.3.0预告：支持咪咕平台。（Jay Chou的歌还是相当不错的，可惜网易云没版权，但是咪咕有啊，所以，，，嘿嘿嘿，，，）\n---------\n此外，特别感谢 夏悠悠 博主(https://blog.csdn.net/qq_42730750)提供的py程序。\n----------\nby迷惘   22.4.1");
        }
