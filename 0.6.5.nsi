...
OutFile "jingziqi-0.6.5-setup.exe"
InstallDir "$PROGRAMFILES\jingziqi"
InstallDirRegKey HKLM "${PRODUCT_UNINST_KEY}" "UninstallString"
ShowInstDetails show
ShowUnInstDetails show

Section "jingziqi" SEC01
  SetOutPath "$INSTDIR"
  ...
  File "bin\Release\kuwo.pdb"
  File "bin\Release\kuwo.exe.config"
  File "bin\Release\kuwo.exe"
  ...
  File "bin\Release\py\search.txt"
  File "bin\Release\py\kuwo.exe"
  File "bin\Release\py\kugou.exe"
  File "bin\Release\py\10.txt"
  File "bin\Release\py\9.txt"
  File "bin\Release\py\8.txt"
  File "bin\Release\py\7.txt"
  File "bin\Release\py\6.txt"
  File "bin\Release\py\5.txt"
  File "bin\Release\py\4.txt"
  File "bin\Release\py\3.txt"
  File "bin\Release\py\2.txt"
  File "bin\Release\py\1.txt"
  SetOutPath "$INSTDIR\py\download"
  SetOutPath "$INSTDIR\"
  File "E:\kuwo\kuwo\bin\Release\winmm.dll"
  SetOutPath "$INSTDIR\swiftshader"
  File "bin\Release\swiftshader\*.*"
...
Section Uninstall
  ...
  Delete "$INSTDIR\kuwo.exe"
  Delete "$INSTDIR\kuwo.exe.config"
  Delete "$INSTDIR\kuwo.pdb"
