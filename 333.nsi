...
; 许可协议页面
!insertmacro MUI_PAGE_LICENSE "D:\C#井字棋\xuke.txt"
; 安装目录选择页面
...
Function un.onInit
  MessageBox MB_ICONQUESTION|MB_YESNO|MB_DEFBUTTON2 "您确实要完全移除 hello ，及其所有的组件？" IDYES +2
  Abort
FunctionEnd

Function un.onUninstSuccess
  HideWindow
  MessageBox MB_ICONINFORMATION|MB_OK "hello 已成功地从您的计算机移除。"
FunctionEnd
